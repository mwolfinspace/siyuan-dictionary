...
module.exports = class DictionaryPlugin extends Plugin {
  ...
  _showToolbar(rect, text) {
    ...
    const buttons = [
      { icon: "iconCut", title: "Cut", action: () => { this._execCut(text); this._removeToolbar(); } },
      { icon: "iconCopy", title: "Copy", action: () => { this._execCopy(text); this._removeToolbar(); } },
      { icon: "iconPaste", title: "Paste", action: () => { this._execPaste(); this._removeToolbar(); } },
